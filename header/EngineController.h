...
class EngineController {
  ...
  public:
    ...
    void
    SetPosition(const std::string &fenString); // Set position to fen string
    ...
    std::string Search(const int wTime, const int bTime, const int winc,
                       const int binc); // Search routine
    ...
    std::string SplitPerft(
        int depth); // Split perft prints out number of leaves after each move
    void FullPerftTest(); // Runs a full perft test suite
    void Bench(); // Benchmarking with a fixed depth perft on a large number of
                  // positions
    void Validate(); // Validates move generation on test suit
    std::string
    Evaluate(); // Evaluate the current position to test static evaluation
    ...
    void
    UndoLastMove(); // Debug to test functionality
                    // -------------------------------------------------------------------
};
// -------------------------------------------------------------------
